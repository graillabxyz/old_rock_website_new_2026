...
function BadgeIcon({ badge, size = "md" }: BadgeIconProps) {
  ...
  return (
    <>
      <div
        ref={badgeRef}
        className={`relative ${sizeClasses} ${opacity} transition-opacity group cursor-help flex-shrink-0 overflow-visible`}
        onMouseEnter={() => {
      ...
      >
        ...
        <div className="absolute inset-0 rounded-lg bg-gray-800/80 border border-gray-700 z-0 backdrop-blur-sm overflow-visible" />
          ...
          <>
            ...
            {[...Array(2)].map((_, i) => (
              <motion.div
                ...
                className="absolute inset-0 rounded-lg z-[5]"
                style={{
                  background: `radial-gradient(circle, transparent 45%, rgba(139, 92, 246, ${0.4 - i * 0.15}) 48%, rgba(139, 92, 246, ${0.6 - i * 0.2}) 50%, rgba(139, 92, 246, ${0.4 - i * 0.15}) 52%, transparent 55%)`,
                  borderRadius: '50%',
                }}
                animate={{
