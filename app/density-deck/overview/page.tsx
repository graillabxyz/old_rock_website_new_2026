            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center mb-8 sm:mb-10 md:mb-12">
                ...
                <div className="space-y-4 max-w-sm mx-auto lg:mx-0">
                  ...
                  >
                    <div className="mb-4">
                      <h3 className="text-lg font-black font-montserrat text-white">QUICK OVERVIEW</h3>
                    </div>
                    <div className="space-y-3 text-sm font-pt-mono text-gray-300">
                      ...
                      <div className="flex justify-between">
                        <span>Deck Size:</span>
                        <span className="text-white font-bold">50 cards</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Skill Level:</span>
                        <span className="text-white font-bold">Easy to Master</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="mb-4">
                      <h3 className="text-lg font-black font-montserrat text-white">KEY FEATURES</h3>
                    </div>
                    <div className="space-y-2 text-xs font-pt-mono text-gray-300">
                      <div className="flex items-center space-x-2">
                        <div className="w-1.5 h-1.5 bg-purple-400 rounded-full"></div>
                        <span>Color synergy mechanics</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-1.5 h-1.5 bg-pink-400 rounded-full"></div>
                        <span>Strategic hand management</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-1.5 h-1.5 bg-orange-400 rounded-full"></div>
                        <span>Escalating round complexity</span>
                      </div>
                      <div className="flex items-center space-x-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h3 className="text-xl font-black font-montserrat text-white">HAND BUILDING</h3>
                    </div>
                    <p className="text-gray-300 font-pt-mono text-sm leading-relaxed mb-3">
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h3 className="text-xl font-black font-montserrat text-white">COLOR SYNERGIES</h3>
                    </div>
                    <p className="text-gray-300 font-pt-mono text-sm leading-relaxed mb-3">
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h3 className="text-xl font-black font-montserrat text-white">TACTICAL COMBAT</h3>
                    </div>
                    <p className="text-gray-300 font-pt-mono text-sm leading-relaxed mb-3">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <motion.div
                  ...
                  transition={{ delay: 1.3, duration: 0.8 }}
                >
                  <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-md border border-white/20 rounded-2xl p-8">
                    <div className="text-center mb-6">
                      <Heart className="w-10 h-10 text-red-400 mx-auto mb-3" />
                      <h2 className="text-2xl font-black font-montserrat text-white mb-3">ESCALATING STAKES</h2>
                      <p className="text-sm font-pt-mono text-gray-300 leading-relaxed">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-black font-montserrat text-white mb-1">Round Escalation</h4>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-black font-montserrat text-white mb-1">Life Management</h4>
                          <p className="text-gray-300 font-pt-mono text-xs leading-relaxed">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-black font-montserrat text-white mb-1">Adaptive Strategy</h4>
                          <p className="text-gray-300 font-pt-mono text-xs leading-relaxed">
                ...
                >
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 justify-center flex-col space-y-[53px]">
                    <div className="text-center mb-6">
                      <Users className="w-10 h-10 text-purple-400 mx-auto mb-3" />
                      <h2 className="text-2xl font-black font-montserrat text-white mb-3">COMPETITIVE PLAY</h2>
                      <p className="text-sm font-pt-mono text-gray-300 leading-relaxed">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-6">
                      <div className="bg-gradient-to-b from-green-900/30 to-green-800/20 rounded-lg p-3 border border-green-500/30 text-center">
                        <div className="text-lg font-black font-montserrat text-white">NOVICE</div>
                        <div className="text-green-300 font-pt-mono text-xs">$10 ENTRY</div>
                      </div>
                      <div className="bg-gradient-to-b from-blue-900/30 to-blue-800/20 rounded-lg p-3 border border-blue-500/30 text-center">
                        <div className="text-lg font-black font-montserrat text-white">ADVANCED</div>
                        <div className="text-blue-300 font-pt-mono text-xs">$20 ENTRY</div>
                      </div>
                      <div className="bg-gradient-to-b from-yellow-900/30 to-yellow-800/20 rounded-lg p-3 border border-yellow-500/30 text-center">
                        <div className="text-lg font-black font-montserrat text-white">PRO</div>
                        <div className="text-yellow-300 font-pt-mono text-xs">$50 ENTRY</div>
                      </div>
                    </div>

                    <div className="flex flex-col gap-3">
                      <Button
                        className="group relative overflow-hidden bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-400 hover:via-pink-400 hover:to-orange-400 text-white border-0 px-6 py-3 text-base font-bold rounded-xl transition-all duration-300 hover:scale-105 font-pt-mono shadow-xl shadow-purple-500/25"
                        onClick={() => window.open("https://densitydeck.com", "_blank")}
                      >
                        <span className="relative z-10 flex items-center justify-center space-x-2 my-0">
                          <Play className="w-4 h-4" />
                          <span>START PLAYING</span>
                        </span>
                        <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 py-0"></div>
                      </Button>

                      <Button
                        variant="outline"
                        className="bg-white/10 backdrop-blur-md border border-white/30 text-white hover:bg-white/20 px-6 py-3 text-base font-bold rounded-xl transition-all duration-300 hover:scale-105 font-pt-mono"
                        onClick={() => (window.location.href = "/density-deck/tournaments")}
                      >
