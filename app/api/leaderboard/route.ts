...
/**
 * GET /api/leaderboard
 * Fetches leaderboard data with wallet addresses, ENS names, and $DENSITY balances
 * This serves as the source of truth for searchable profiles
 */
  ...
  try {
    ...
    if (!amplifyApiUrl) {
      return NextResponse.json(
        { success: false, error: "Amplify API URL not configured" },
        { status: 500 }
      )
    }
